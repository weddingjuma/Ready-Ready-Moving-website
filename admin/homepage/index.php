...
<head>
	...
	<title>Ready Ready Moving - Home Page Settings</title>
	...
	<div class="app-container" style="max-width:100%;">
		...
		<form class="form-grouped" action="submit.php" method="post" enctype="multipart/form-data" data-validate>		
		  ...
		  <fieldset>
			...
			<div class="row form-group">
			  <div class="col-md-3 col-xs-8">
				<label>1st Testimonial Photo</label>
			...
			<div class="row form-group">
			  <div class="col-md-12 col-xs-12">
				<label>1st Testimonial Quote</label>
				<input class="form-control" type="text" name="testimonial1_quote" <?php echo 'value="'.$setting['testimonial1_quote'].'"'; ?> required>
			  </div>
			</div>
			<div class="row form-group">
			  <div class="col-md-12 col-xs-12">
				<label>1st Testimonial Name</label>
				<input class="form-control" type="text" name="testimonial1_name" <?php echo 'value="'.$setting['testimonial1_name'].'"'; ?> required>
			  </div>
			</div>
			<div class="row form-group">
			  <div class="col-md-3 col-xs-8">
				<label>2nd Testimonial Photo</label>
