...
<head>
	...
	<title>Ready Ready Moving - Add/Edit Portfolio item</title>
			...
			<div class="row form-group">
			  <div class="col-md-4 col-xs-4">
				...
				<select name="category1">
					...
					<option value="commercial" <?php if($u["category1"] == "commercial") { echo 'selected'; } ?>>Commercial</option>
					<option value="residential" <?php if($u["category1"] == "residential") { echo 'selected'; } ?>>Residential</option>
					<option value="repair" <?php if($u["category1"] == "repair") { echo 'selected'; } ?>>Repair</option>
				</select>
			  </div>
			  <div class="col-md-4 col-xs-4">
				...
				<select name="category2">
					...
					<option value="commercial" <?php if($u["category2"] == "commercial") { echo 'selected'; } ?>>Commercial</option>
					<option value="residential" <?php if($u["category2"] == "residential") { echo 'selected'; } ?>>Residential</option>
					<option value="repair" <?php if($u["category2"] == "repair") { echo 'selected'; } ?>>Repair</option>
				</select>
			  </div>
			  <div class="col-md-4 col-xs-4">
				...
				<select name="category3">
					...
					<option value="commercial" <?php if($u["category3"] == "commercial") { echo 'selected'; } ?>>Commercial</option>
					<option value="residential" <?php if($u["category3"] == "residential") { echo 'selected'; } ?>>Residential</option>
					<option value="repair" <?php if($u["category3"] == "repair") { echo 'selected'; } ?>>Repair</option>
				</select>
			  </div>
			</div>
		  </fieldset>
