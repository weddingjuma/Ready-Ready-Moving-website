...
<head>
	...
	<title>Ready Ready Moving - Portfolio</title>
	...
	<div class="app-container" style="max-width:100%;">
		...
		<form class="form-inline row" method="post">
			<div class="col-xs-8 col-md-11">
				<?php 
					if($search == "") {
						echo "<input name=\"search\" type=\"search\" placeholder=\"Search portfolio\" class=\"form-control\">";
					} else {
						echo "<input name=\"search\" type=\"search\" placeholder=\"Search portfolio\" class=\"form-control\" value=\"".$search."\">";
					}
				?>
			</div>
		...
		<a href="edit.php" class="btn btn-default"><b>+</b> Add new portfolio</a>
