<?php
	...
	if($id == "") {
		if(mysqli_query($c, "insert into products(title, description, price, sale_price, on_sale, category1, category2, category3, image1, image2, image3, image4, image5, image6, image7, image8) 
