	...
	<div class="row featured">
		<div class="col-xs-12 col-md-8 featured_padding">
			<div class="featured_content">
				<span class="featured_title">"When you're ready, we're ready ready!" </span><br /><br />
				<span class="featured_subtitle"><?php echo $setting['aboutus']; ?></span><br /><br /><br />
			</div>
		</div>
	</div>
