...
<head>
	...
	<?php 
		echo get_seo($c, "pricing", $setting); 
...
<body>
	...
	<div class="row presentation_short" style="background-image: url('<?php echo $setting['feature1_photo']; ?>');">
		<div class="col-xs-12 col-md-8 presentation_padding_short">
			<div class="presentation_content">
				<span class="page_title">Pricing</span>
			</div>
		</div>
	...
	<div class="row featured">
		<div class="col-xs-12 col-md-8 featured_padding">
			<div class="featured_content">
				<span class="featured_title"><?php echo $setting['testimonial1_quote']; ?></span><br /><br />
				<span class="featured_subtitle"><?php echo $setting['testimonial1_name']; ?></span><br /><br /><br />
			</div>
		</div>
	</div>
